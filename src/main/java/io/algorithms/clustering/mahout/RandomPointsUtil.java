...
public class RandomPointsUtil {
    ...
    private  static void generateSamples(List<Vector> sampleData, int num, double mx,
            double my, double sd, int card) {
        for (int i = 0; i < num; i++) {
    ...
    /**
     * Generate 2-d samples for backwards compatibility with existing tests25      * @param numint number of samples to generate
     * @param mx double x-value of the sample mean
     * @param mydouble y-value of the sample mean
     * @param sddouble standard deviation of the samples
     */
    public static void generateSamples(List<Vector> sampleData, int num, double mx,
            double my, double sd) {
